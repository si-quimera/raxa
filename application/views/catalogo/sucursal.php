							...
							<div class="col s12">
								...
								<table class="highlight">
									<thead>
										<tr>
											<th>
												<a href="<?= base_url() ?>Catalogos/sucursal/?order=Nombre&amp;by=DESC"><i class="material-icons">arrow_drop_down</i></a>
												Sucursal
												<a href="<?= base_url() ?>Catalogos/sucursal/?order=Nombre&amp;by=ASC"><i class="material-icons">arrow_drop_up</i></a>
											</th>
											<th>
												<a href="<?= base_url() ?>Catalogos/sucursal/?order=Id_Ciudad&amp;by=DESC"><i class="material-icons">arrow_drop_down</i></a>
												Ciudad
												<a href="<?= base_url() ?>Catalogos/sucursal/?order=Id_Ciudad&amp;by=ASC"><i class="material-icons">arrow_drop_up</i></a>
											</th>
