            ...
            <div class="main-content">
				...
				<div class="row">
				    <div class="col s12">
				        <div class="page-header">
				            <h1>
				                <i class="material-icons">account_box</i> EDITAR COLABORADOR
				            </h1>
				        </div>
				    </div>
				</div>
				...
				<section id="apps_crud">
					<div class="crud-app">																		
                        ...
                        <?php
						$Password = $this->encryption->decrypt($edicion->Password);
						
                        $hidden = array('Id_Colaborador' => $edicion->Id_Colaborador);
                        echo form_open('Catalogos/editColaborador/'.$edicion->Id_Colaborador, '', $hidden); 
                        ?>						
                            <div class="row">
                                    ...
                                    <div class="panel panel-bordered">				
                                        <div class="panel-body">                                           
                                            <div class="row no-gutter">
                                                ...
                                                <div class="input-field col s6">
                                                    <input name="Ap_Pat" id="Ap_Pat" type="text" value="<?= $edicion->Ap_Pat ?>">
                                            ...
                                            <div class="row no-gutter">
                                                <div class="input-field col s6">
                                                    <input name="Ap_Mat" id="Ap_Mat" type="text" value="<?= $edicion->Ap_Mat ?>">
                                                    <label for="Ap_Mat">Ap Materno</label>
													<?php echo form_error('Ap_Mat'); ?>
                                                </div>	
                                                <div class="col s6">
													<label for="Fec_Nac">Fecha Nacimiento</label>
                                                    <input name="Fec_Nac" type="text" class="datepicker" id="Fec_Nac" value="<?= $edicion->Fec_Nac ?>">                                                    
													<?php echo form_error('Fec_Nac'); ?>																																						
                                                </div>												
                                            </div>  
                                            <div class="row no-gutter">
                                                <div class="input-field col s6">
                                                    <input name="Calle" id="Calle" type="text" value="<?= $edicion->Calle ?>">
                                            ...
                                            <div class="row no-gutter">
                                                <div class="input-field col s6">
                                                    <input name="Municipio" id="Municipio" type="text" value="<?= $edicion->Municipio ?>">
                                            ...
                                            <div class="row no-gutter">
                                                <div class="input-field col s6">
                                                    <input name="Estado" id="Estado" type="text" value="<?= $edicion->Estado ?>">
                                                    <label for="Estado">Estado</label>
													<?php echo form_error('Estado'); ?>
                                                </div>
                                                <div class="input-field col s6">
                                                    <input name="Pais" id="Pais" type="text" value="<?= $edicion->Pais ?>">
                                            ...
                                            <div class="row no-gutter">
                                                <div class="input-field col s6">
                                                    <input name="Tel" id="Tel" type="text" value="<?= $edicion->Tel ?>">
                                            ...
                                            <div class="row no-gutter">
                                                <div class="input-field col s6">
                                                    <input name="Cel" id="Cel" type="text" value="<?= $edicion->Cel ?>">
                                                    <label for="Cel">Cel</label>
													<?php echo form_error('Cel'); ?>
                                                </div>												
                                                <div class="input-field col s6">
                                                    <input name="IMEI" id="IMEI" type="text" value="<?= $edicion->IMEI ?>">
                                            ...
                                            <div class="row no-gutter">
                                                <div class="input-field col s6">
                                                    <input name="Cel2" id="Cel2" type="text" value="<?= $edicion->Cel2 ?>">
                                                    <label for="Cel2">Cel 2</label>
													<?php echo form_error('Cel2'); ?>
                                                </div>													
                                                <div class="input-field col s6">
                                                    <input name="IMEI2" id="IMEI2" type="text" value="<?= $edicion->IMEI2 ?>">
                                            ...
                                            <div class="row no-gutter">
                                                <div class="input-field col s6">
                                                    <input name="email" id="email" type="text" value="<?= $edicion->email ?>">
                                                ...
                                                <div class="col s6">
                                                    ...
                                                    <?php
														...
														foreach ($level1->result() as $row1) {   
															...
															if($row1->Id_Cat_Prim == $edicion->Id_Cat_Puesto){
													?>	
													...
													<?php																	
															...
															foreach ($level2->result() as $row2) { 
																...
																if($row2->Id_Cat_Prim == $edicion->Id_Cat_Puesto){																
													?>	
