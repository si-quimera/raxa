				...
				<section id="apps_crud">
					<div class="crud-app">
						<div class="fixed-action-btn">
							<a class="btn-floating btn-large tooltipped pulse" data-tooltip="Nuevo Grupo" data-position="top" data-delay="50" href="<?= base_url() ?>Catalogos/newGrupo">
									...
									?>									
										<tr>
											...
											<td class="center-align">
												<div class="btn-group">
													<a href="<?= base_url() ?>Catalogos/editGrupo/<?= $row->Id_Grupo ?>" class="btn-flat btn-small waves-effect">
														<i class="material-icons">create</i>
													</a>
													
													<a href="#" onclick="if (confirm(&quot;Estas seguro que quieres borrarlo # <?= $row->Nombre ?>?&quot;)) { window.location.href = '<?= base_url() . "Catalogos/delGrupo/" . $row->Id_Grupo ?>' } event.returnValue = false; return false;" class="btn-flat btn-small waves-effect btnDelete">
