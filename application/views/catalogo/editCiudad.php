				...
				<section id="apps_crud">
					<div class="crud-app">
                        <div class="fixed-action-btn">
                            <a class="btn-floating btn-large tooltipped" data-tooltip="Regresar" data-position="top" data-delay="50" href="<?= base_url().'Catalogos/ciudad' ?>">
                        ...
                        echo form_open('Catalogos/editCiudad/'.$edicion->Id_Ciudad, '', $hidden); 
                        ?>
                            <div class="row">
