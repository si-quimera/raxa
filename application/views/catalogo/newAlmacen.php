				...
				<div class="row">
				    <div class="col s12">
				        <div class="page-header">
				            <h1>
				                <i class="material-icons">card_membership</i> AGREGAR ALMACEN
				            </h1>
				        </div>
				    </div>
				</div>
				...
				<section id="apps_crud">
					<div class="crud-app">																		
                        <div class="fixed-action-btn">
                            <a class="btn-floating btn-large tooltipped" data-tooltip="Regresar" data-position="top" data-delay="50" href="<?= base_url().'Catalogos/almacen' ?>">
                        ...
                        <?php
                        echo form_open('Catalogos/newAlmacen/'); 
                        ?> 
                            <div class="row">
