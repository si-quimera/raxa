                ...
                <div class="row">
                    <div class="col s12">
                        <div class="page-header">
                            <h1>
                                <i class="material-icons">map</i> GENERACIÓN DE PORTABILIDAD
                            </h1>
                        </div>
                    </div>
                </div>
						...
						<div class="fixed-action-btn">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s6">
                                    <button type="submit" class="btn waves-effect" id="LoadRecordsGenButton">Buscar ...</button>
                                </div>
                            </div>

                            <div id="GenPortaTableContainer" style="width: 100%"></div>
					</div>
				</section>
