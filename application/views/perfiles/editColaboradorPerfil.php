            ...
            <div class="main-content">
				...
				<section id="apps_crud">
					<div class="crud-app">																		
                        ...
                        <?php
                        $hidden = array('Id_Colaborador_Perfil' => $edicion->Id_Colaborador_Perfil);
                        echo form_open('Perfiles/editColaboradorPerfil/'.$edicion->Id_Colaborador_Perfil, '', $hidden); 						
                        ?>							
                            <div class="row">
                                    ...
                                    <div class="panel panel-bordered">				
                                        <div class="panel-body">                                           
                                            <div class="row no-gutter">
                                                ...
                                                <div class="col s6">
													<label for="Id_Perfil">Pefil</label> 
